...
function Section13() {
  return (
    <>
      {/* section top text  */}
      <div className="purple-circles-half">
        <div className="mx-12 pt-20">
          <div className="flex justify-between">
            <span className="text-[48px] font-light leading-[38px] text-white">
          ...
          <div className="border-b-[1px] opacity-40 mt-10"></div>
        </div>
      </div>
      {/* bottom  */}
      <div className="mx-12 mt-16">
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-6 lg:col-span-2">
            <a target="_blank" rel="noreferrer" href="https://helohealth.com/">
          ...
          <div className="col-span-6 lg:col-span-2">
            <a target="_blank" rel="noreferrer" href="https://www.odee.com/">
              <div className="border-[1px] rounded-xl border-[#FCFCFC33] flex justify-center items-center h-[76px]  container-purple-line">
                <span className="z-[2]">
                  <img
                    alt="odee"
          ...
          <div className="col-span-6 lg:col-span-2">
            <a target="_blank" rel="noreferrer" href="https://metamask.io/">
              <div className="border-[1px] rounded-xl border-[#FCFCFC33] flex justify-center items-center h-[76px] z-1 container-purple-line">
                <span className="z-[2]">
                  <img
                    alt="metamask"
                    loading="lazy"
          ...
          <div className="col-span-6 lg:col-span-2">
            <a target="_blank" rel="noreferrer" href="https://trustwallet.com/">
              <div className="border-[1px] rounded-xl border-[#FCFCFC33] flex justify-center items-center h-[76px] container-purple-line">
                <span className="z-[2]">
                  <img
                    alt="trust-wallet"
          ...
          <div className="col-span-6 lg:col-span-2">
            <a target="_blank" rel="noreferrer" href="https://inpersona.com/">
              <div className="border-[1px] rounded-xl border-[#FCFCFC33] flex justify-center items-center h-[76px] container-purple-line">
                <span className="z-[2]">
                  <img
                    alt="inPersona"
