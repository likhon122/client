...
function Section3() {
  return (
    <>
      <div className="validators-bg-2">
        <div className="mx-4 lg:mx-12">
          <div className="grid grid-cols-12 lg:gap-x-16 relative 2xl:pt-[400px]">
            <div className=" lg:col-span-12"></div>
            <div className="col-span-12 flex flex-col lg:my-10 pt-[40%] lg:pt-[20%] xl:pt-[30%] 2xl:pt-0">
              <span className="hidden lg:block mb-4 text-[#FCFCFC] text-[12px] font-light">
                VALIDATORS &amp; DELEGATORS
              </span>
              <span className="text-[28px] leading-[36px] lg:text-[90px] lg:leading-[92px] font-light text-white">
                Roles and responsibilities <br />
                <span className="faded-pink-to-orange">
                  of Validators &amp; Delegators
                </span>
              </span>
            </div>
            <div className="col-span-12 lg:col-span-4 border-b-[1px] lg:border-b-0 lg:border-r-[1px] border-[#404040]">
              <div className="p-6 flex flex-col gap-4 lg:gap-y-24">
                <div className="flex justify-between">
                  <span className="hidden lg:block">
                    <img
                      ...
                      decoding="async"
                      data-nimg="1"
                      srcSet="https://www.vyvo.com/_next/image?url=%2Fshapes%2F3-diagonal-squares.png&amp;w=64&amp;q=75 1x, https://www.vyvo.com/_next/image?url=%2Fshapes%2F3-diagonal-squares.png&amp;w=128&amp;q=75 2x"
                      src="https://www.vyvo.com/_next/image?url=%2Fshapes%2F3-diagonal-squares.png&amp;w=128&amp;q=75"
                  ...
                  <span className="text-[#777578] text-[21px] leading-[24px]">
                    001
                  </span>
                </div>
                <span className="faded-lilac-alt text-[24px] lg:text-[36px] font-light">
                  Transaction Fee
                </span>
              </div>
            </div>
              ...
              <div className="p-6 flex flex-col gap-4 lg:gap-y-24">
                ...
                <div className="flex flex-col gap-y-4">
                  ...
                  <span className="text-[#DFDFDF] text-base font-light">
                    ...
                    make an error, each of their delegators are at risk of being
                    partially slashed in proportion to their delegated stake.
                  </span>
                </div>
              </div>
            </div>
