          ...
          <div className="grid grid-cols-12 lg:gap-x-16 relative lg:top-[280px]">
            <div className="col-span-12 lg:col-span-11 lg:mb-10">
              ...
              <span className="text-[36px] leading-[36px] lg:text-[90px] lg:leading-[92px] font-light text-white">
                <span className="faded-tangerine">Validated</span> Health Data
                <br />
                <span className="faded-tangerine">from real</span> people
              </span>
            </div>
            ...
            <div className="hidden lg:block lg:col-span-1 mt-4 lg:mt-0">
              <img
                alt="nft"
                loading="lazy"
                width="37"
            ...
            <div className="col-span-12 lg:hidden mt-4 lg:mt-0">
              <img
                alt="nft"
                loading="lazy"
                width="17"
            ...
            <div className="col-span-12 lg:col-span-4 my-4 lg:my-0">
              <span className="text-white text-base font-light leading-[22px]">
                Researchers, institutions, and organizations have access to a
                <span className="faded-tangerine">
                  &nbsp;Decentralised Digital Health (DDH)
                </span>{" "}
                Platform with authenticated health data from all over the world.
              </span>
            </div>
            <div className="col-span-12 lg:col-span-3 data-buyer-bg-mobile">
              <span className="text-white text-base font-light leading-[22px]">
                Leverage our ecosystem to drive innovation, research, and
                decision-making in your industry.
              </span>
            </div>
            <div className="h-0.5  bg-white/25 rounded-sm w-full col-span-12 lg:mt-16"></div>
            <div className="col-span-6 lg:col-span-4">
              <p className="text-[#979797] font-light leading-[18px] mt-3 text-[10px] lg:text-xs">
